...
bmtype={'type':'dsscore','dslist':looplist+nlooplist,'criteria':'10xNativeSelection','combine':'scoresum','bm':'bs2dsp'}
...
dsearch7={'object':pm,'key':0,'valueset':['gps0.3','gps0.6','gps1.0','gps2.0','ks0.3','ks0.6','ks1.0','ks2.0']}
...
refineProtocal={bm:'loop.fast.1000',}
dsearchRP1={'object':ssmodel,'key':'index','valueset':['acc']}
...
def looprefine_eval(cv):
    sprefiner=sprefine(dslist='ml12',**refineProtocal)
    return sprefiner.get_task(cv)

#pdb.set_trace()
spl=spss(model=model1,evalPotFunc=looprefine_eval)

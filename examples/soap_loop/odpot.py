...
par={'uniform':3,'featurebins':rfeature[0],'distribute':'lownumberpriority','firstpoint':2.25}
slo={'key':'sacnfflex',
    'valueset':{
                    'sacnfflex':{'sftype':'sacnf','par':par,'parvalue':[1,1,1,1]},
                        ...
                        'psn6':{'sftype':'psn','par':range(6),'parvalue':range(6)},
                        'psn7':{'sftype':'psn','par':range(7),'parvalue':range(7)},
...
ref1={'type':'sf','features':'dt12#6','sftype':slo,'par':slo,'parvalue':slo,'ratio':[1.0]}
ref2={'type':'sf','features':'dt1#6g6#180','sftype':'spline','par':[0,60,120,180],'parvalue':[1,1,1,1],'ratio':[1.0]}
ref3={'type':'sf','features':'dt1#6gs6#180','sftype':'spline','par':[0,60,120,180],'parvalue':[1,1,1,1],'ratio':[1.0]}
ref4={'type':'sf','features':'dt1#6h12#180#-180','sftype':'spline','par':[-180,-60,60,180],'parvalue':[1,1,1,1],'ratio':[1.0]}

scaledsp1={'type':'scaledsp','pdbset':'X_2.2A_0.25rfree','features':'dt12#6g6#180gs6#180h12#180#-180t306ts306','genmethod':'bs2dsp','pm':pm,'refs':[ref1,ref2,ref3,ref4],'ratio':[1.0]}
...
bmtype={'type':'dsscore','dslist':looplist,'criteria':'top1_rmsd_mean_','combine':'scoresum','bm':'bs2dsp'}#3xtop1_rmsd_mean_+NativeSelection+2xtop3_rmsd_mean_
...
#define the search positions
search3={'object':ref2,'key':'parvalue','pos':[0,1,2,3],'InitialGenerator':{'type':'sin','values':np.arange(0,20)/10.0}}
search4={'object':ref3,'key':'parvalue','pos':[0,1,2,3],'InitialGenerator':{'type':'sin','values':np.arange(0,20)/10.0}}
search5={'object':ref4,'key':'parvalue','pos':[0,1,2,3],'InitialGenerator':{'type':'sin','values':np.arange(0,20)/10.0}}
...
dsearch10={'object':scaledsp1,'key':'features','valueset':['dt30#15g6#180gs6#180h12#360t306ts306']}
...
#dsearch5={'object':rfeature[0],'key':3,'valueset':[0.5]}#0.025,0.05 #,0.25,0.1,0.05 #0.05,0.1,0.25,

dsearch6={'object':slo,'key':'key','valueset':slo['valueset'].keys()}#slo['valueset'].keys()'psn5','psn3','psn4','psn8'

dsearch7={'object':pm,'key':0,'valueset':['','ks0.1','ks0.2','ks0.3','ks0.6','ks1.0','ks2.0']}#'gps0.6','gps0.3',,'ks0.2','ks0.4'
#,'gps0.3','gps0.1','gps1.0','gps2.0',
dsearch8={'object':par,'key':'uniform','valueset':[6,5,4,3,2]}
...
model1={'scorers':[scaledsp1,ref1,ref2,ref3,ref4],'bmtype':bmtype,'searches':[search1,search2,search3,search4,search5], 'runsperscorer':ni,
    'dsearches':[dsearch7,dsearch8],'sml':sml,'cvk':3,'repeat':1,'fold':3}#,dsearch2,dsearch5,dsearch6,dsearch7 #,'testperc':0.33
